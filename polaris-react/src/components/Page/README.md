...
<Page
  title="Product"
  primaryAction={{content: 'Save', tooltip: <span>Save is an <strong>async</strong> operation</span>}}
  secondaryActions={[{content: 'Import', disabled: true, tooltip: 'You need permission to import products'}]}
>
